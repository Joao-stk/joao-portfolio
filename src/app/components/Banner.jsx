  ...
  return (
    ...
    <section id="home" className="flex flex-col snap-start relative md:grid md:grid-cols-2 w-full min-h-screen overflow-visible md:overflow-hidden">
      ...
      <motion.div
        ...
        transition={{ duration: 1.5, type: "spring", stiffness: 80, damping: 12 }}
        viewport={{ once: false, amount: 0.5 }}
        className="flex min-h-screen items-center justify-center bg-white/10 mb-0 md:mb-[5%] px-2 sm:px-4"
      >
        <div className="w-full flex flex-col items-center gap-8 sm:gap-10 px-2 sm:px-6 py-8 sm:py-10">
          ...
          <div className="w-full max-w-md bg-white/20 rounded-2xl shadow-2xl p-4 sm:p-8 flex flex-col items-center gap-4 sm:gap-6 outline-2 outline-purple-300">
          ...
          <div className="flex flex-col items-center gap-2 sm:gap-4 w-full mt-8 sm:mt-[30%]">
            ...
            <div className="flex gap-4 sm:gap-8 flex-wrap justify-center">
              <motion.a {...iconsAnimation}>
                <svg className={buttonTecnologias + " w-8 h-8 sm:w-10 sm:h-10"} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                  {/* React */}
              ...
              <motion.a {...iconsAnimation}>
                <svg className={buttonTecnologias + " w-8 h-8 sm:w-10 sm:h-10"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                  {/* Next.js */}
