      ...
      <div className="hidden md:block min-h-screen">
        <div className="h-full hidden md:flex min-h-screen items-center justify-center bg-white/10  mb-[5%]">
          <div className=" h-full flex flex-col items-center gap-10 px-6 py-10">
            ...
            <div className="w-full max-w-md bg-white/20 rounded-2xl shadow-2xl p-8 flex flex-col items-center gap-6 outline-2 outline-purple-300">
              <div className="grid grid-cols-2 gap-6 w-full">
                <div className="flex flex-col items-center bg-white/70 rounded-xl p-4 shadow">
                  <p className="text-4xl font-extrabold text-purple-700 mb-1">5+</p>
                  <p className="text-base text-gray-700 font-medium text-center">Anos de<br />Experiência</p>
                </div>
                <div className="flex flex-col items-center bg-white/70 rounded-xl p-4 shadow">
                  <p className="text-4xl font-extrabold text-purple-700 mb-1">20+</p>
                  <p className="text-base text-gray-700 font-medium text-center">Projetos<br />Completos</p>
                </div>
              </div>
              <div className="flex flex-col items-center bg-white/70 rounded-xl p-4 shadow w-2/3 mx-auto">
                <p className="text-4xl font-extrabold text-purple-700 mb-1">10+</p>
                <p className="text-base text-gray-700 font-medium text-center">Clientes<br />Satisfeitos</p>
              </div>
            </div>
            {/* Tecnologias */}
            <div className="flex flex-col items-center gap-4 w-full mt-[30%]">
              <p className="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-rose-500 font-medium">Tecnologias:</p>
              <div className="flex gap-8">
                <motion.a {...iconsAnimation}>
                  <svg className={buttonTecnologias} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 24 24">
                    {/* React */}
                ...
                <motion.a {...iconsAnimation}>
                  <svg className={buttonTecnologias} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 128 128">
                    {/* Next.js */}
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://github.com/seuusuario" target="_blank" rel="noopener noreferrer">
                <svg className="w-7 h-7 text-gray-300 hover:text-purple-400" /* github svg */ />
              </a>
              <a href="https://linkedin.com/in/seuusuario" target="_blank" rel="noopener noreferrer">
                <svg className="w-7 h-7 text-gray-300 hover:text-purple-400" /* linkedin svg */ />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-sm text-gray-200/70">
        <span className="inline-flex items-center gap-2">
          <a href={buttonRightHref}>
            <svg className="w-10 h-10 animate-bounce" fill="none" stroke="purple" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
