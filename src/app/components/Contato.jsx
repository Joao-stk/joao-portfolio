...
import { bgDiv, iconStyle, hoverEffect, buttonFullStyle, buttonOutlineStyle, gradientText } from "./Styles";


function Contato() {
    return (
        <section id="contato" className="relative h-screen flex flex-col justify-center">
            {/* Losango de fundo */}
            ...
            <div className="grid grid-cols-3 mt-10 ml-[5%] h-[80%] w-[90%] gap-10">
                <div className="w-full mt-[10%] col-span-1 mb-[10%] flex flex-col justify-around p-5">
                    <h2 className="justify-center text-center text-3xl">Redes Sociais</h2>

                    <div className="flex flex-row h-20 items-center rounded-xl p-2 shadow-sm shadow-white outline-black outline-1">
                ...
                <div className="w-full col-span-2 mt-[10%] mb-[10%] flex flex-col justify-around p-5">
                    <div className="justify-center text-center h-full w-full">
                        ...
                        <form className="flex flex-col mt-10 gap-6 w-[80%] ml-auto mr-auto text-base">
                            ...
                            <textarea
                                ...
                                className={buttonOutlineStyle + " rounded-lg text-left h-30 md:h-40 lg:h-50 fith-content "}
                            ></textarea>
                            <button
                                type="submit"
