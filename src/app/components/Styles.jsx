...
export const buttonOutlineStyle ="bg-transparent border-2 border-purple-500 mt-6 flex justify-center items-center text-center gap-3 rounded-full px-4 py-2 text-sm md:px-8 md:py-4 md:text-base lg:px-12 lg:text-lg font-bold text-purple-500 shadow-lg";
